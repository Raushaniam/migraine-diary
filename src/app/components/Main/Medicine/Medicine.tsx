...
export const Medicine: FC<IMedicine> = ({title}) => {
    ...
    return <div className="Medicine">
        ...
        <div className="MedicineContainer">
            <div className="MedicineHeading">
                <div className="Heading">{Dictionary.Name}</div>
                <div className="Heading">{Dictionary.DOSE}</div>
                <div className="Svg" onClick={addMedicineBox}>
                    <svg className="Pluse" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 24 24"
                         width="24px"
                         height="24px">
                        <path
